...
#define TAS2557_CAL_NAME    "/mnt/vendor/nvcfg/audio/tas2557_cal.bin"
...
int tas2557_agc_enable(struct tas2557_priv *pTAS2557, bool bEnable)
{
	int ret = 0;
	unsigned char p_enable_data[] = { 0x00, 0x00, 0x00, 0x00 };

	if (bEnable)
		p_enable_data[2] = 0x00;
	else
		p_enable_data[2] = 0x01;

	ret = pTAS2557->bulk_write(pTAS2557, TAS2557_AGC_ENABLE_REG, p_enable_data, 4);
	if (ret < 0)
		return ret;

	pTAS2557->mbAgcEnable = bEnable;
