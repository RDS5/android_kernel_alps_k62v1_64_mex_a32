...
#define TAS2557_AGC_ENABLE_REG			TAS2557_REG(0, 51, 64)
...
#define TAS2557_FW_NAME     "tas2557_uCDSP"
#define TAS2557_PG1P0_FW_NAME     "tas2557_pg1p0"
#ifdef CONFIG_HUAWEI_DEVICEBOX_AUDIO
#define GET_FW2_1_NAME(tas2557_fw_name,pFWName)\
    do {\
        snprintf(tas2557_fw_name, (unsigned long)MAX_FW_NAME, "%s_%s.bin", TAS2557_FW_NAME, boxtable[deviceboxID_read(0)]);\
        pFWName = tas2557_fw_name;\
    }while(0)

#define GET_FW1_0_NAME(tas2557_fw_name,pFWName)\
    do {\
            snprintf(tas2557_fw_name, (unsigned long)MAX_FW_NAME, "%s_%s.bin", TAS2557_PG1P0_FW_NAME, boxtable[deviceboxID_read(0)]);\
            pFWName = tas2557_fw_name;\
    }while(0)
...
#define GET_FW2_1_NAME(tas2557_fw_name,pFWName)\
    do {\
            snprintf(tas2557_fw_name, (unsigned long)MAX_FW_NAME, "%s_%s.bin", TAS2557_FW_NAME, "DEFAULT");\
            pFWName = tas2557_fw_name;\
    }while(0)
#define GET_FW1_0_NAME(tas2557_fw_name,pFWName)\
    do {\
            snprintf(tas2557_fw_name, (unsigned long)MAX_FW_NAME, "%s_%s.bin", TAS2557_PG1P0_FW_NAME, "DEFAULT");\
            pFWName = tas2557_fw_name;\
    }while(0)
...
extern char * boxtable[];
extern char tas2557_fw_name[MAX_FW_NAME];
