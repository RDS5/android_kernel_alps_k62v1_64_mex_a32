...
#define BTS_USBNTC_RAP_PULL_UP_R		390000 /* 390K, pull up resister */
...
#define BTS_USBNTC_RAP_NTC_TABLE		7 /* NTCG103JF103F (10K) */
#define BTS_USBNTC_RAP_ADC_CHANNEL		AUX_IN3_NTC /* default is 3 */
