...
extern int als_data_report(int value, int, int, int status);
extern int als_data_report_t(int value, int, int, int status, int64_t time_stamp);
...
extern int ps_data_report(int value, int, int, int status);
extern int ps_data_report_t(int value, int, int, int status, int64_t time_stamp);
