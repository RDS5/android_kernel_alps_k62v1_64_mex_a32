...
#define SENSOR_TYPE_FINGER_SENSE                       74

/* end sensor type */
#define SENSOR_TYPE_MAX_NUM                            SENSOR_TYPE_FINGER_SENSE
...
#define ID_FINGER_SENSE               (ID_BASE + SENSOR_TYPE_FINGER_SENSE - 1)
/* end sensor ID */
#define ID_SENSOR_MAX_HANDLE    (ID_FINGER_SENSE)
