...
static void SCP_sensorHub_init_sensor_state(void)
{
	...
	mSensorState[SENSOR_TYPE_FINGER_SENSE].sensorType = SENSOR_TYPE_FINGER_SENSE;
	mSensorState[SENSOR_TYPE_FINGER_SENSE].rate = SENSOR_RATE_ONCHANGE;
	mSensorState[SENSOR_TYPE_FINGER_SENSE].timestamp_filter = false;
}
