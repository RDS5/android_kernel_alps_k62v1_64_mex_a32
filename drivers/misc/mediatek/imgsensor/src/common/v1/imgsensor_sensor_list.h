...
UINT32 OV8856_HLT_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
...
UINT32 S5K5E9YX_SUNRISE_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 s5k4h7_txd_sensorinit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
...
UINT32 HI556_SEASONS_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
/*MT*/
...
UINT32 GC2375_SUNNY_MONO_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 GC2375_SUNNY_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 GC8034_SUNWIN_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 GC8034_TXD_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
