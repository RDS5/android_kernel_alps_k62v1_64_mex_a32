 ...
 *
 * hi846_truly image sensor config settings
 *
...
#define HI864_OTP_REG_CMD	0x0702
#define HI864_OTP_REG_WDATA	0x0706
#define HI864_OTP_REG_RDATA	0x0708
#define HI864_OTP_REG_ADDRH	0x070A
#define HI864_OTP_REG_ADDRL	0x070B

#define HI864_OTP_CMD_NORMAL			0x00
#define HI864_OTP_CMD_CONTINUOUS_READ	0x01
#define HI864_OTP_CMD_CONTINUOUS_WRITE	0x02

#define HI864_OTP_OFFSET_MODULE_FLAG	0x0CC0
#define HI864_OTP_OFFSET_MODULE1		(0x0CC1 + 3)
#define HI864_OTP_OFFSET_MODULE2		(0x1430 + 3)
#define HI846_TRULY_MODULE_ID	2

struct hi846_otp_t {
	kal_uint8 flag_module;
	kal_uint8 mid;
};
static struct hi846_otp_t otp_info = {0};
