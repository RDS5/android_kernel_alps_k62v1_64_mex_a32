#ifndef __GC5035P_MIPI_SENSOR_H__
#define __GC5035P_MIPI_SENSOR_H__

/* SENSOR MIRROR FLIP INFO */
#define GC5035P_MIRROR_FLIP_ENABLE         0
#if GC5035P_MIRROR_FLIP_ENABLE
#define GC5035P_MIRROR                     0x83
#define GC5035P_RSTDUMMY1                  0x03
#define GC5035P_RSTDUMMY2                  0xfc
#else
#define GC5035P_MIRROR                     0x80
#define GC5035P_RSTDUMMY1                  0x02
#define GC5035P_RSTDUMMY2                  0x7c
#endif

/* SENSOR PRIVATE INFO FOR GAIN SETTING */
#define GC5035P_SENSOR_GAIN_BASE             256
#define GC5035P_SENSOR_GAIN_MAX              (16 * GC5035P_SENSOR_GAIN_BASE)
#define GC5035P_SENSOR_GAIN_MAX_VALID_INDEX  17
#define GC5035P_SENSOR_GAIN_MAP_SIZE         17
#define GC5035P_SENSOR_DGAIN_BASE            0x100
...
struct gc5035p_sn_info_t {
	kal_uint8 data[GC5035P_OTP_SN_VALID_DATA_SIZE + 1];
};
...
struct gc5035p_otp_t {
	...
	kal_uint8 otp_buf[GC5035P_OTP_BUF_SIZE];
