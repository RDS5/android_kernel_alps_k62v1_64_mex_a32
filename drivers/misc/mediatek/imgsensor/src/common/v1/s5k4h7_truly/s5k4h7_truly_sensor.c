/*
 * s5k4h7_truly_sensor.c
 *
 * Copyright (c) 2018-2019 Huawei Technologies Co., Ltd.
 *
 * s5k4h7_truly image sensor driver
 *
...
#define PFX "[s5k4h7_truly]"
#define DEBUG_S5K4H7_TRULY 0
#define LOG_DBG(fmt, args...) \
	do { \
		if (DEBUG_S5K4H7_TRULY) \
...
static kal_uint32 feature_control_s5k4h7_truly(MSDK_SENSOR_FEATURE_ENUM
		feature_id,
...
static struct SENSOR_FUNCTION_STRUCT sensor_func = {
	...
	get_info,
	get_resolution,
	feature_control_s5k4h7_truly,
	control,
	close
};

UINT32 S5K4H7_TRULY_SensorInit(struct SENSOR_FUNCTION_STRUCT **pf_func)
{
	if (pf_func != NULL)
		*pf_func = &sensor_func;
	return ERROR_NONE;
