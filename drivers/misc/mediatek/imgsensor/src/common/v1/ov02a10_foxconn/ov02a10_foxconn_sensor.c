/*
 * ov02a10_foxconn_sensor.c
 *
 * ov02a10_foxconn image sensor driver
 *
...
#include "ov02a10_foxconn_sensor.h"
...
#define PFX "[ov02a10_foxconn]"
#define DEBUG_OV02A10_FOXCONN 0
#define LOG_DBG(fmt, args...) \
	do { \
		if (DEBUG_OV02A10_FOXCONN) \
			pr_debug(PFX "%s %d " \
...
static kal_uint32 feature_control_ov02a10_foxconn(MSDK_SENSOR_FEATURE_ENUM
...
static struct SENSOR_FUNCTION_STRUCT sensor_func = {
	...
	get_info,
	get_resolution,
	feature_control_ov02a10_foxconn,
	control,
	close
};

UINT32 OV02A10_FOXCONN_SensorInit(struct SENSOR_FUNCTION_STRUCT **pf_func)
{
