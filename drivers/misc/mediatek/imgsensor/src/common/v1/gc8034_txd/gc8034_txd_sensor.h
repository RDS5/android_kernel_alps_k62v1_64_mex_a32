...
#ifndef _GC8034_TXD_SENSOR_H
#define _GC8034_TXD_SENSOR_H
...
#undef  GC8034_TXD_MIRROR_NORMAL
#undef  GC8034_TXD_MIRROR_H
#undef  GC8034_TXD_MIRROR_V
#undef  GC8034_TXD_MIRROR_HV

#define  GC8034_TXD_MIRROR_NORMAL

#if defined(GC8034_TXD_MIRROR_NORMAL)
	#define GC8034_TXD_MIRROR         0xc0
	#define GC8034_TXD_BINSTARTY      0x04
	#define GC8034_TXD_BINSTARTX      0x05
	#define GC8034_TXD_FULLSTARTY     0x08
	#define GC8034_TXD_FULLSTARTX     0x09
#elif defined(GC8034_TXD_MIRROR_H)
	#define GC8034_TXD_MIRROR         0xc1
	#define GC8034_TXD_BINSTARTY      0x04
	#define GC8034_TXD_BINSTARTX      0x05
	#define GC8034_TXD_FULLSTARTY     0x08
	#define GC8034_TXD_FULLSTARTX     0x0b
#elif defined(GC8034_TXD_MIRROR_V)
	#define GC8034_TXD_MIRROR         0xc2
	#define GC8034_TXD_BINSTARTY      0x04
	#define GC8034_TXD_BINSTARTX      0x05
	#define GC8034_TXD_FULLSTARTY     0x08
	#define GC8034_TXD_FULLSTARTX     0x09
#elif defined(GC8034_TXD_MIRROR_HV)
	#define GC8034_TXD_MIRROR         0xc3
	#define GC8034_TXD_BINSTARTY      0x04
	#define GC8034_TXD_BINSTARTX      0x05
	#define GC8034_TXD_FULLSTARTY     0x08
	#define GC8034_TXD_FULLSTARTX     0x0b
...
#undef GC8034_TXD_OTP_FOR_CUSTOMER
#define GC8034_TXD_OTP_FOR_CUSTOMER
...
struct gc8034_txd_dd_t {
	kal_uint16 x;
	kal_uint16 y;
	kal_uint16 t;
};

struct gc8034_txd_otp_t {
	kal_uint8  dd_cnt;
	kal_uint8  dd_flag;
	kal_uint8  reg_flag;
	kal_uint8  reg_num;
...
static struct imgsensor_i2c_reg init_setting[] = {
	...
	{ 0xc3, 0xff, 0x00 },
	{ 0x90, 0x01, 0x00 },
	{ 0x92, GC8034_TXD_BINSTARTY, 0x00 },
	{ 0x94, GC8034_TXD_BINSTARTX, 0x00 },
	{ 0x95, 0x09, 0x00 },
	{ 0x96, 0x90, 0x00 },
	{ 0x97, 0x0c, 0x00 },
	{ 0x98, 0xc0, 0x00 },
...
static struct imgsensor_i2c_reg capture_setting[] = {
	...
	{ 0xbc, 0x09, 0x00 },
	{ 0x90, 0x01, 0x00 },
	{ 0x92, GC8034_TXD_FULLSTARTY, 0x00 },
	{ 0x94, GC8034_TXD_FULLSTARTX, 0x00 },
	{ 0x95, 0x09, 0x00 },
	{ 0x96, 0x90, 0x00 },
	{ 0x97, 0x0c, 0x00 },
	{ 0x98, 0xc0, 0x00 },
...
static struct imgsensor_info_t imgsensor_info = {
	.sensor_id_reg = 0xf0,
	.sensor_id = GC8034_TXD_SENSOR_ID, // defined in kd_imgsensor.h
