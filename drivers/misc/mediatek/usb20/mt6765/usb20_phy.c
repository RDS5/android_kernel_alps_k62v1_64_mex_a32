...
#define DEFAULT_DEV_VRT_REF 7
#define DEFAULT_DEV_TERM_REF 7
#define DEFAULT_DEV_ENHANCE 3
#define DEFAULT_HOST_VRT_REF 4
#define DEFAULT_HOST_TERM_REF 2
#define DEFAULT_HOST_ENHANCE 2
...
static void get_phy_eye_para(int mode, u32 *vrt, u32 *term, u32 *enhance)
{
	...
	pr_info("%s mode:%d, vrf:%d, term:%d, enhance:%d\n",
		__func__, mode, *vrt, *term, *enhance);
}
