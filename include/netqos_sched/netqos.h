...
#if !defined(_TRACE_NETQOS_H) || defined(TRACE_HEADER_MULTI_READ)
#define _TRACE_NETQOS_H
...
extern bool netqos_trace_add_check(struct sock *sk, int len,
		bool is_ecv, unsigned long cur_time);
extern void netqos_trace_assign_set(struct sock *sk, int *tx,
